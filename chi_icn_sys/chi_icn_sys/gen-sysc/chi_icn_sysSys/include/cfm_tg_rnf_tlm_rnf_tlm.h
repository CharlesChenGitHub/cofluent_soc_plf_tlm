...
#ifndef COFS_MODEL_CHI_ICN_SYSSYS_TG_RNF_TLM_RNF_TLM
#define COFS_MODEL_CHI_ICN_SYSSYS_TG_RNF_TLM_RNF_TLM
...
class cfm_tg_rnf_tlm_rnf_tlm: public cf_core::cf_master_interface {
public:
	/// cfm_tg_rnf_tlm_rnf_tlm type define start

	/// cfm_tg_rnf_tlm_rnf_tlm type define end

	/// constructor
	cfm_tg_rnf_tlm_rnf_tlm(sc_core::sc_module_name name);

	/// destructor
	virtual ~cfm_tg_rnf_tlm_rnf_tlm(void);
...
//@}
//@}
#endif // COFS_MODEL_CHI_ICN_SYSSYS_TG_RNF_TLM_RNF_TLM
